...
""" 
USAGE
script.py CONTCAR (number of fixed bulk atoms) (xc name)

"""
'''
NOTE The default of having teh coordinates in cartesians in turned off by setting direct = True in the io/vasp.py line 629, module from this ase package.
...
#Info for kpoints
lenghts= CONTCAR_x.get_cell_lengths_and_angles()
...
kpointx = round(30.0/lenghts[0],2)
kpointy = round(30.0/lenghts[1],3)
